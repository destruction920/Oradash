...
def main():
    clients = [
        ...
        {"name": "BIGMARTMIS", "label": "DBA_Bigmart", "subject": f"MMT-GINMIS DATABASE LONGQUERY INFO {datetime.now().strftime('%d%m%y')}", "folder": os.path.join(ATTACHMENTS_BASE, "BIGMART(MIS)", "longquery")},
        ...
        {"name": "GURRAM", "label": "DBA_Gurram", "subject": f"GRM-GINESYS DATABASE LONG QUERY INFO {datetime.now().strftime('%d%m%y')}", "folder": os.path.join(ATTACHMENTS_BASE, "GURRAM", "longquery")},
         {"name": "GURRAMCTM", "label": "DBA_Gurram", "subject": f"GRM-GURRAM DATABASE LONG QUERY INFO {datetime.now().strftime('%d%m%y')}", "folder": os.path.join(ATTACHMENTS_BASE, "GURRAMCTM", "longquery")},
        ...
        {"name": "MUFTIPRD", "label": "DBA_Mufti", "subject": f"MUFTI-GINESYS DATABASE LONG QUERY INFO {datetime.now().strftime('%d%m%y')}", "folder": os.path.join(ATTACHMENTS_BASE, "MUFTI", "longquery")},
        {"name": "MUFTIMIS", "label": "DBA_Mufti", "subject": f"MUFTI-GINMIS DATABASE LONGQUERY INFO {datetime.now().strftime('%d%m%y')}", "folder": os.path.join(ATTACHMENTS_BASE, "MUFTI(MIS)", "longquery")},
        ...
        {"name": "SOCHPRD", "label": "DBA_Soch", "subject": f"SCH-GINESYS DATABASE LONG QUERY INFO {datetime.now().strftime('%d%m%y')}", "folder": os.path.join(ATTACHMENTS_BASE, "SOCH", "longquery")},
        {"name": "SOCHMIS", "label": "DBA_Soch", "subject": f"SCH-GINMIS DATABASE LONGQUERY INFORMATION {datetime.now().strftime('%d%m%y')}", "folder": os.path.join(ATTACHMENTS_BASE, "SOCH(MIS)", "longquery")},
        ...
        {"name": "STYLEBAAZARMIS", "label": "DBA_Stylebazar", "subject": f"STL-GINESYS DATABASE GINMIS LONGQUERY INFO {datetime.now().strftime('%d%m%y')}", "folder": os.path.join(ATTACHMENTS_BASE, "STYLEBAAZAR(MIS)", "longquery")},
